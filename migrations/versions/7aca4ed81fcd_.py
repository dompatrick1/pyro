...
Revision ID: 7aca4ed81fcd
Revises: 
Create Date: 2021-05-05 18:05:30.207612
...
def upgrade():
    ...
    sa.Column('lastPlayed', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['lastPlayed'], ['albums.id'], ),
    ...
    sa.Column('lastListen', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['lastListen'], ['albums.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('playCount', sa.Numeric(), nullable=False),
    sa.Column('userId', sa.Integer(), nullable=False),
    sa.Column('albumId', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['albumId'], ['albums.id'], ),
    sa.ForeignKeyConstraint(['userId'], ['users.id'], ),
